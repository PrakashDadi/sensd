(() => {
  const data = [
    ...
    { tag: "AI Estimation models", q: "What is baseline life?", a: "Baseline life is the expected shelf life at the reference temperature (for example, 7.16 days at 5Â°C). It is only used to convert equivalent time into remaining days." },
    { tag: "AI Estimation models", q: "What is reference temperature and why does it matter?", a: "Reference temperature is the storage temperature used as the baseline for calculations. Equivalent time is computed as â€œtime at reference temp,â€ so changing the reference temp changes the rate and remaining life estimates." },
    { tag: "AI Estimation models", q: "What does 'Equivalent time @ reference' mean?", a: "It is the amount of time your profile is equivalent to if it had been stored at the reference temperature. It is computed by integrating temperatureâ€‘dependent spoilage rates across the time series." },
    { tag: "AI Estimation models", q: "Why do different models show different equivalent times?", a: "Each model uses a different temperatureâ€‘response relationship. Q10, Arrhenius, and MKT are not identical and will produce different equivalent times, especially when temperatures vary." },
    { tag: "AI Estimation models", q: "What is the Avg Temp + Q10 model?", a: "It computes a timeâ€‘weighted average temperature and applies a Q10 rate based on that single value. It is simple but less accurate for variable temperature profiles." },
    { tag: "AI Estimation models", q: "What is the Q10 Integrated model?", a: "It applies the Q10 rate to each time step and integrates across the full series. It is more accurate than the averageâ€‘temperature approach for changing temperatures." },
    { tag: "AI Estimation models", q: "What is the Arrhenius Integrated model?", a: "It uses the Arrhenius equation to compute temperatureâ€‘dependent spoilage rates at each time step and integrates over time. It is often used for biological and chemical degradation modeling." },
    { tag: "AI Estimation models", q: "What is MKT (Mean Kinetic Temperature)?", a: "MKT compresses a temperature profile into a single effective temperature that reflects higher temperatures more heavily. It is commonly used in stability and coldâ€‘chain analysis." },
    { tag: "AI Estimation models", q: "Why does FEFO now match other models?", a: "FEFO uses the same equivalentâ€‘time calculation as the other models, so its remainingâ€‘life estimates stay consistent instead of spiking due to simple cutâ€‘off logic." },
    { tag: "AI Estimation models", q: "Do these models use the graph data?", a: "Yes. All shelfâ€‘life models are computed from the same active series that is displayed in the AI Estimation chart (uploaded files or live logger data)." },
    { tag: "AI Estimation models", q: "Can I download a detailed calculation report?", a: "Yes. The AI Estimation page includes a link to download a text report with inputs, equivalent time values, and remaining shelfâ€‘life estimates for each model." },
    ...
    { tag: "AI ChatBot", q: "What questions can the AI ChatBot answer?", a: "It can summarize sensor data, explain trends, highlight alerts, and provide shelfâ€‘life insights based on uploads or live logger data. For live status, include a logger ID or label." },
